      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* <div>
            ...
            <div className="space-y-2">
              <div className="text-gray-400 text-sm">Personal Diary</div>
              <div className="text-gray-400 text-sm">Social Community</div>
              <div className="text-gray-400 text-sm">Smart Discovery</div>
              <div className="text-gray-400 text-sm">Advanced Ratings</div>
            </div>
          </div> */}
           <div>
            <h3 className="text-white font-semibold mb-4">Quick Links</h3>
